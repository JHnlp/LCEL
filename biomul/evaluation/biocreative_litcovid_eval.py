...
def print_label_based_scores(labels, preds, topics, threshold=0.5):
...
def print_instance_based_scores(labels, preds, topics, threshold=0.5):
    ...
    info = {'mean precision': mean_prc, 'mean recall': mean_rec, 'f1': f_score}
    return info
